...
@InputType()
class RentalCreateNestedManyWithoutInventoriesInput {
...
export { RentalCreateNestedManyWithoutInventoriesInput as RentalCreateNestedManyWithoutInventoriesInput };
